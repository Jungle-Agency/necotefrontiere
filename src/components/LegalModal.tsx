  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li><strong>Email :</strong> frontiswissconnect@gmail.com</li>
...
function PrivacyContent() {
  return (
    <div>
      ...
      <p>Pour exercer ces droits, contactez-nous à : <strong>frontiswissconnect@gmail.com</strong></p>
      ...
      <p>
        ...
        contacter à : <strong>frontiswissconnect@gmail.com</strong>
      </p>
    </div>
  );
}
